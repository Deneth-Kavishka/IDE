...
export default function ShareModal({ isOpen, onClose }: ShareModalProps) {
  ...
  const handleCopyLink = () => {
    navigator.clipboard.writeText("https://antigravity.studio/workspace/share/xyz123");
    setCopied(true);
        ...
        <div className="p-6 flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2.5">
            ...
            <div className="flex items-center gap-2">
              ...
              <button className="bg-indigo-600 hover:bg-indigo-500 text-white px-5 py-3 rounded-xl text-sm font-semibold transition-all shadow-md shadow-indigo-900/30 hover:shadow-[0_0_12px_rgba(99,102,241,0.5)] shrink-0 cursor-pointer flex items-center gap-1.5">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-3.5">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Alex&backgroundColor=b6e3f4" className="w-9 h-9 rounded-full border border-slate-700/80 shadow-sm" alt="Alex" />
                  <div className="flex flex-col">
                    <span className="text-sm font-semibold text-slate-200">Alex (AI Expert)</span>
                    <span className="text-[11px] text-slate-500 font-mono">alex@example.com</span>
                  </div>
                </div>
                <div className="relative group shrink-0">
                  <select className="appearance-none bg-transparent hover:bg-slate-800 border border-transparent hover:border-slate-700 text-slate-300 text-xs font-medium px-3 py-1.5 pr-7 rounded-lg outline-none cursor-pointer transition-colors">
                    <option value="Editor">Editor</option>
                    <option value="Viewer">Viewer</option>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Sam&backgroundColor=c0aede" className="w-9 h-9 rounded-full border border-slate-700/80 shadow-sm" alt="Sam" />
                  <div className="flex flex-col">
                    <span className="text-sm font-semibold text-slate-200">Sam Designer</span>
                    <span className="text-[11px] text-slate-500 font-mono">sam@example.com</span>
                  </div>
                </div>
                <div className="relative group shrink-0">
                  <select defaultValue="Viewer" className="appearance-none bg-transparent hover:bg-slate-800 border border-transparent hover:border-slate-700 text-slate-300 text-xs font-medium px-3 py-1.5 pr-7 rounded-lg outline-none cursor-pointer transition-colors">
                    <option value="Editor">Editor</option>
                    <option value="Viewer">Viewer</option>
                    <option value="Remove">Remove access</option>
                  </select>
